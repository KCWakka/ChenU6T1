public class ArrayManipulator {
     ...
     */
    public ArrayManipulator(int[] nums, int howManyStrings) { /* implement this method! */
        this.nums = nums;
     ...
     */
    public int getNumsMiddleIndex() { /* implement this method! */
        if (nums.length % 2 == 0) {
     ...
     */
    public double getNumsAverage() { /* implement this method! */
     ...
     */
    public boolean sameLengths() { /* implement this method! */
     ...
     */
    public boolean updateWordsListAt(int idx, String newValue) { /* implement this method */
        if (idx < words.length && idx > -1) {
            words[idx] = newValue;
            return true;
        } else {
            return false;
     ...
     */
    public int howLongLastWord() { /* implement this method */
